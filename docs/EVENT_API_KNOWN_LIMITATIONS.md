...
6. **Datapack Isolation & Global Registries (ADR-0002)**:
   ...
   - See complete Architectural Decision Record in [ADR-0002-datapack-isolation.md](file:///m:/projects/RonlabGameAssistant/docs/adr/ADR-0002-datapack-isolation.md).

---

## Related Documentation

- [ADR-0002-datapack-isolation.md](file:///m:/projects/RonlabGameAssistant/docs/adr/ADR-0002-datapack-isolation.md)
- [companion-integration.md](file:///m:/projects/RonlabGameAssistant/docs/companion-integration.md)
- [DECISION_35_TESTING_FRAMEWORK.md](file:///m:/projects/RonlabGameAssistant/docs/qa/DECISION_35_TESTING_FRAMEWORK.md)
