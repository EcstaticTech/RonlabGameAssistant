...
* [ ] Implement robust `onDisable()` cleanup and recovery detection.
...
* [ ] Add first-visit spawn support to world config.
* [ ] Add configurable hub entry behavior and inventory confirmation.
